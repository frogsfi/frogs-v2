    ...
    mainLogic = async (isEthLottery: boolean) => {
        ...
        this.beforeAll(async () => {
            ...
            if (isEthLottery)
                ...
                lottery = all.lotteryERC20
            // console.log(isEthLottery, lottery.address)
        })
        it("deposit", async () => {
